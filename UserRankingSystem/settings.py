...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(os.path.dirname(BASE_DIR), "UserRankingSystem","static_cdn", "media_root")

STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "UserRankingSystem","static_cdn","static_root")